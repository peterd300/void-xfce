...
echo "============================================================================="
echo " Starting Void Linux & XFCE Installer "
echo "============================================================================="
...
echo "========================================================================================================" >> "$LOG_FILE" 2>&1
echo "[4/15] Installing Xorg server ..." | tee -a "$LOG_FILE"
echo "========================================================================================================" >> "$LOG_FILE" 2>&1
sudo xbps-install -Sy xorg xorg-server xorg-apps xrandr xterm twm xinit xsel xclip xcolor >> "$LOG_FILE" 2>&1


echo "========================================================================================================" >> "$LOG_FILE" 2>&1
echo "[5/15] Installing XFCE4 and some plugins ..." | tee -a "$LOG_FILE"
echo "========================================================================================================" >> "$LOG_FILE" 2>&1

(
sudo xbps-install -Sy xfce4 xfce4-whiskermenu-plugin  xfce4-panel xfce4-pulseaudio-plugin  xfce4-clipman-plugin xfce4-weather-plugin >> "$LOG_FILE" 2>&1

) >> "$LOG_FILE" 2>&1

echo "========================================================================================================" >> "$LOG_FILE" 2>&1
echo "[6/15] Creating X11 environment configuration (.xinitrc)..." | tee -a "$LOG_FILE"
echo "========================================================================================================" >> "$LOG_FILE" 2>&1
...
echo "========================================================================================================" >> "$LOG_FILE" 2>&1
echo "[8/15] Installing some X11 applications..." | tee -a "$LOG_FILE"
echo "========================================================================================================" >> "$LOG_FILE" 2>&1

(
    sudo xbps-install -Sy firefox-esr kitty ghostty flameshot gmrun xbindkeys xdotool xev gpick arandr gpick CopyQ zathura zathura-cb zathura-pdf-mupdf octoxbps
    mkdir -p ~/screenshots
) >> "$LOG_FILE" 2>&1

echo "========================================================================================================" >> "$LOG_FILE" 2>&1
echo "[9/15] Installing Thunar, file manager..." | tee -a "$LOG_FILE"
echo "========================================================================================================" >> "$LOG_FILE" 2>&1
...
echo "========================================================================================================" >> "$LOG_FILE" 2>&1
echo "[10/15] Installing Geany, text editor..." | tee -a "$LOG_FILE" |
echo "========================================================================================================" >> "$LOG_FILE" 2>&1
...
echo "========================================================================================================" >> "$LOG_FILE" 2>&1
echo "[11/15] Installing and configuring system audio permissions..." | tee -a "$LOG_FILE"
echo "========================================================================================================" >> "$LOG_FILE" 2>&1
...
echo "========================================================================================================" >> "$LOG_FILE" 2>&1
echo "[12.1/15] Install XFCE Themes + Icons..." | tee -a "$LOG_FILE"
echo "========================================================================================================" >> "$LOG_FILE" 2>&1
(
...
echo "========================================================================================================" >> "$LOG_FILE" 2>&1
echo "[12.3/15] Installing Jetbrain (Nerd) System and other fonts..." | tee -a "$LOG_FILE"
echo "========================================================================================================" >> "$LOG_FILE" 2>&1
...
echo "========================================================================================================" >> "$LOG_FILE" 2>&1
echo "[12.4/15] Installing Kora icons theme..." | tee -a "$LOG_FILE"
echo "========================================================================================================" >> "$LOG_FILE" 2>&1
...
echo "========================================================================================================" >> "$LOG_FILE" 2>&1
echo "[14/15] Installing firewall with some rules ..." | tee -a "$LOG_FILE"
echo "========================================================================================================" >> "$LOG_FILE" 2>&1
